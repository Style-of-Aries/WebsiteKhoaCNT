    ...
    <form method="POST" action="index.php?controller=semester&action=add">
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" id="academic_year" name="academic_year"
                    value="<?= htmlspecialchars($old['academic_year'] ?? $defaultYear) ?>"
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input type="date" id="end_date" name="end_date" value="<?= htmlspecialchars($old['end_date'] ?? '') ?>"
                    readonly required>
            </div>
        </div>

        <button type="submit" class="btn-submit" name="btn_add">
            Tạo học kỳ
        </button>
