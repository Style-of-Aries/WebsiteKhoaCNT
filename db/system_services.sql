  ...
  --
  -- Máy chủ: 127.0.0.1
  -- Thời gian đã tạo: Th1 07, 2026 lúc 01:59 PM
  ...
  INSERT INTO `academic_results` (`id`, `student_id`, `subject_id`, `semester_id`, `final_grade`) VALUES
  (1, 16, 1, 1, 8.50),
  (2, 16, 2, 1, 7.80),
  (3, 17, 1, 1, 6.90),
  (4, 18, 3, 1, 8.20);
  ...
  (1, 'CNTT K19A', 'CNTT19A', 3, 4),
  (2, 'CNTT K19B', 'CNTT19B', 3, 11),
  (3, 'cnt03', 'cnt04', 2, 4),
  (4, '', '', 2, 4),
  (10, 'e', 'e', 2, 4);
  ...
  (16, 'Nguyễn Văn Tứ', 'SV001', 'sv1@gmail.com', 1),
  (17, 'Lê Thị B', 'SV002', 'sv2@gmail.com', 1),
  (18, 'Phạm Văn C', 'SV003', 'sv3@gmail.com', 2),
  (19, 'Nguyễn Văn Tứ', 'msv1234', 'tutue9692@gmail.com4848444', 1),
  (20, 'Nguyễn Văn Tứ', 'sc', 'tutue9692@gmail.comcjhacbjb', 1);
