          ...
          <tr>
            ...
            <td class="action">
              <button class="edit-button"
                onclick="location.href='index.php?controller=user&action=editUser&id=<?= $user['id'] ?>&ref_id=<?= $user['ref_id'] ?>'">
              ...
              <button class="delete-button"
                onclick="if(confirm('Xóa người dùng này?')) location.href='index.php?controller=user&action=deleteUsers&id=<?= $user['id'] ?>&ref_id=<?= $user['ref_id'] ?>&role=<?= $user['role'] ?>'">
