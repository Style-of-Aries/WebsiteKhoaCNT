...
<div class="admin-table-wrapper">
    <button class="back-button"
        onclick="location.href='index.php?controller=lecturer&action=getCourseClass&type=score'">
                            ...
                            <?php if ($role === 'admin' || $role === 'exam_office'): ?>
                                <td class="dkthi">
                                    ...
                                    if ($status === null) {
                                        ...
                                        $status = round($status, 1); // làm tròn 1 chữ số thập phân
                            
                                        if ($status >= 5) {
                                            echo "<span class='eligible'>Đủ điều kiện</span><br><small>($status)</small>";
                                        } else {
                                            echo "<span class='not-eligible'>Không đủ</span><br><small>($status)</small>";
                                        }
                                    }
                                    ?>
                                </td>
