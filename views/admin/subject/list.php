        ...
        <?php foreach ($subjects as $index => $subject): ?>
          <tr>
            ...
            <td class="action">
              ...
              <a href="index.php?controller=subject&action=deleteMonHoc&id=<?= $subject['id'] ?>"
                class="action-btn delete-btn" onclick="return confirm('Xóa môn học này?')"><i
                  class="ri-delete-bin-line"></i> Xóa</a> -->
              <button class="edit-button"
                onclick="location.href='index.php?controller=subject&action=editMonHoc&id=<?= $subject['id'] ?>&user=<?= $subject['name'] ?>'">
              ...
              <button class="delete-button"
                onclick="if(confirm('Xóa lớp học này?')) location.href='index.php?controller=subject&action=deleteMonHoc&id=<?= $subject['id'] ?>'">
