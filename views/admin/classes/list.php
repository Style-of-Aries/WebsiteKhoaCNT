          ...
          <tr>
            ...
            <td class="action">
              ...
              <a href="index.php?controller=classes&action=deleteLh&id=<?= $class['id'] ?>" class="action-btn delete-btn"
                ...
                onclick="location.href='index.php?controller=classes&action=getAllSinhVienCuaLop&id=<?= $class['id'] ?>&user=<?= $class['class_name'] ?>'">
              ...
              <button class="edit-button"
                onclick="location.href='index.php?controller=classes&action=editLh&id=<?= $class['id'] ?>&user=<?= $class['class_name'] ?>'">
              ...
              <button class="delete-button"
                onclick="if(confirm('Xóa lớp học này?')) location.href='index.php?controller=classes&action=deleteLh&id=<?= $class['id'] ?>'">
